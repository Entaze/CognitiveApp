 ...
 useEffect(()=>{
  ...
  const GetUnratedImages = () => {
    ...
    if (userProfile._id) {
      ...
      .then((res) => {
        if (res.data._56Test3v2Images) {
          num = (Images.length - (res.data._56Test3v2Images.length));
          // console.log('res.data._56Test3v2Images :', Images.length )
        } else {
          num = 0;
        }
  ...
  const GetUnratedImages2 = () => {
    ...
    if (userProfile._id) {
      ...
      axios.get('/api/test3v2Images', {params: param})
      .then((res) => {
        if (res.data._57Test3v2Images2) {
          num = (Images2.length - (res.data._57Test3v2Images2.length));
        } else {
          num = 0;
        }
        //Filter Images and set unrated images
        let imgs = _.takeRight(Images2, num);
        // console.log('imgs 2:', imgs.length)
