...
function CognitiveTest1Recallv2 () {
 ...
 useEffect(()=>{
  if (userAuth) {
    if (userProfile.test1CompletionRecallSctn2v2) {
      setTest5End(true);
    } else {
      setFirstPage(true);
    }
...
useEffect(() => {
 ...
 useEffect(() => {
  if (completionTime) {
      ...
      const expiryDate = moment(completionTime, 'YYYY/MM/DD hh:mm:ss').add(19, 'hours'); //14
...
export default CognitiveTest1Recallv2
